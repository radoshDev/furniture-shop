...
export const path = {
	...
	src: {
		...
		images: `${srcFolder}/${imgFolder}/**/*.{jpg,jpeg,png,gif,webp,ico}`,
	...
	favicon: {
		src: `${srcFolder}/${imgFolder}/favicon/favicon.svg`,
		watch: `${srcFolder}/${imgFolder}/favicon/favicon.svg`,
		dest: `${buildFolder}/${imgFolder}/favicon`,
	},
	buildFolder,
	srcFolder,
	rootFolder,
